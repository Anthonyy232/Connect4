...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports sel_raw]; # First from the first switch
...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports start_raw]; # Center button
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports reset_raw]; # Top button
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports left_raw]; # Left middle button
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports right_raw]; # Right middle button
